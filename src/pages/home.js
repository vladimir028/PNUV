    ...
    return (
        ...
        >
            ...
            >
                ...
                >
                    Добредојде на нашиот сајт!
                </h1>
                <p style={{ fontSize: '1.3rem', lineHeight: '1.7', textShadow: '1px 1px 6px rgba(0,0,0,0.2)' }}>
                    Ова е почетната страница. Нашиот проект е создаден со цел да ја поддржи свеста за менталното здравје и да обезбеди практични алатки за подобрување на емоционалната благосостојба.
                </p>
            </section>
            ...
            >
                ...
                >
                    ...
                    <p style={{ fontSize: '1.15rem', lineHeight: '1.6' }}>
                        Ние сме тим посветен на создавање корисни алатки за учениците. Апликацијата е изработена со цел да се унапреди свесноста за менталното здравје и да се поддржат младите во нивниот развој.
                    </p>
                </div>
